...
#### Context
The scientific publication system has highly shifted towards high profit journals with increasing publication and/or access costs for the scientific and public community. The 'publish or peerish' pressure, especially on early career scientists, is continuing to push into this direction. One identified step to break this dilema is to support 'ethical' journals, for example by preferentially citing works havin gopted for these journals [(Receveur et al. 2024)](https://doi.org/10.1111/ele.14395).
...
#### Usage
Either download & run the script `run_ethics`, or run the following code.
When you have list of DOIs:
```{r eval=FALSE}
